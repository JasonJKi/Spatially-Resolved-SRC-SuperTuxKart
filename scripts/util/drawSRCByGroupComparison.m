function drawSRCByGroupComparison(src_by_group, comparison_grp_index, group_name)

[p_left, h_left, p_right, h_right] = compareSRCByGroup2D(src_by_group, comparison_grp_index, true);
...
for i_group = 1:num_groups
    ...
    if i_group == 1
        ...
        c_axis_tick_label = {round(c_min,2), ['\rho = ' num2str(round(c_axis(2),2))], round(c_max,2)} ;
